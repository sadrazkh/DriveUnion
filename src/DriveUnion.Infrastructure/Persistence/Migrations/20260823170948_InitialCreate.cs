        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RootFolderId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    QuotaTotalBytes = table.Column<long>(type: "bigint", nullable: false),
                    QuotaUsedBytes = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MimeType = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    SizeBytes = table.Column<long>(type: "bigint", nullable: false),
                    DriveResumableUri = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    BytesConfirmed = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareLinks_StoredFiles_StoredFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DownloadEvents_ShareLinks_ShareLinkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DownloadEvents_ShareLinkId_OccurredAt",
                table: "DownloadEvents",
                columns: new[] { "ShareLinkId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_GoogleAccounts_Email",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareLinks_StoredFileId",
                table: "ShareLinks",
                column: "StoredFileId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareLinks_TenantId_CreatedAt",
                table: "ShareLinks",
                columns: new[] { "TenantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_StoredFiles_GoogleAccountId_DriveFileId",
                table: "StoredFiles",
                columns: new[] { "GoogleAccountId", "DriveFileId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UploadSessions_TenantId_Status",
