...
namespace DriveUnion.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828071006_FileLocks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DriveUnion.Core.Notifications.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DriveUnion.Core.Storage.CatalogueSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("ByHand")
                        .HasColumnType("boolean");

                    b.Property<int>("CopiesMade")
                        .HasColumnType("integer");

                    b.Property<int>("CopiesWanted")
                        .HasColumnType("integer");

                    b.Property<int>("EncryptionCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CatalogueSnapshots");
                });

            modelBuilder.Entity("DriveUnion.Core.Storage.CatalogueSnapshotCopy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GoogleAccountId", "RemovedAt");

                    b.ToTable("CatalogueSnapshotCopies");
                });
            ...
            modelBuilder.Entity("DriveUnion.Core.Storage.FileLock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SealedDriveFileId")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
            ...
            modelBuilder.Entity("DriveUnion.Core.Storage.CatalogueSnapshotCopy", b =>
                {
                    b.HasOne("DriveUnion.Core.Storage.CatalogueSnapshot", null)
                        .WithMany()
